...
% change to stimulus domain
%     - change when creating stim.x, fitting params need to account for
%     different scales - both prefit and limits
%       needs to be automatic or set by GUI

% could add option to set hrf lendth in seconds - save to fitParams to
% using in interrogator functions

% remove outputs of HDR fitting and create interrogator function to create
% overlay of first peak

% set HDR length in GUI and set initial params and limits with it

% export HDR length

% prefit with tau as well as exponent

% set prefit and fitting arguements based on stimulus properties -
% increment - mean(diff(x))

% figure out peak time point of HFR and output and verbose

% set limits of search from 0.02 to 20 kHz - convert to ERB
